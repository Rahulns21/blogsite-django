...
def password_change(request):
    ...
    context = {'form': form}
    return render(request, 'users/password_reset_confirm.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if associated_user:
                ...
                if email.send():
                    messages.success(request,
                        ...
                        <p>
                            ...
                            You should receive them shortly.<br>If you don't receive an email, please check your spam folder.
                        </p>
                        """
                    )
                else:
                ...
                messages.error(request, """The email you have entered isn't associated with any account, 
                              you can create a new account using this email""")
